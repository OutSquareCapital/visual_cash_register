...
Module JsonHandler
    Function LoadJSON(fichier As String) As Dictionary(Of String, List(Of Dictionary(Of String, Object)))
    ...
    Function SaveJSON(fichier As String, data As Dictionary(Of String, List(Of Dictionary(Of String, Object)))) As Boolean
        Try
